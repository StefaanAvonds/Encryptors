...
{
    public class AESEncryptor : IEncrypt, IDecrypt
    {
        // Change these keys
        ...
        {
            return ByteArrToString(EncryptString(text));
        }

        /// Encrypt some text and return an encrypted byte array.
        private byte[] EncryptString(string TextValue)
        {
        ...
        {
            return DecryptString(StrToByteArray(text));
        }
